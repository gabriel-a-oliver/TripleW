...
#include "TagStateMachineComponent.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FTagStateChangedSignature, const FGameplayTag&, NewStateTag);
...
class TAGSTATEMACHINE_API UStateMachineComponent : public UActorComponent
{
	GENERATED_BODY()
